...
# Modifiche:
#	0.5- Correzione minore: la ricerca viene effettuata sullo specifico dominio in ingresso, un eventuale sottodominio deve essere dichiarato (esempio: contoso.com nella ricerca non mostrer� i risultati di dep1.contoso.com nell'eventualit� dep1 fosse un suo sottodominio).
...
#	0.2- Inserita notifica di lavorazione per ciascun utente (prima assegnava il campo senza notificare alcunchè durante la lavorazione, si arrivava direttamente alla fine del ciclo ForEach)
############################################################################################################################
