'*******************************************************************************
' Name: OLicenseCleanup.vbs - v 1.13
...
Dim f64, fO64, fCScript, fQuiet, fClearO15, fClearO16
Dim LogStream
...
Sub ClearConfigUser
    ...
    If RegEnumValues(HKLM, sConfigKey, arrNames, arrTypes) Then
        For Each value in arrNames
            If (InStr(LCase(value), LCase(".EmailAddress")) > 0)  OR (LCase(value) = "productkeys") Then
