<#
	...
	Modifiche:
		0.2- ritocco il modo di procurarmi la localizzazione della cartella "Calendar" perché in molti casi il metodo iniziale portava a errori in PowerShell (saltando così la verifica dell'utente).
